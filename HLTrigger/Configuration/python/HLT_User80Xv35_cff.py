...
# /users/rwalsh/dev/CMSSW_8_0_X/MssmHbb/V35 (CMSSW_8_0_24)

fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/rwalsh/dev/CMSSW_8_0_X/MssmHbb/V35')
)
...
fragment.HLTSchedule = cms.Schedule( *(fragment.HLTriggerFirstPath, fragment.HLT_CaloJets_Muons_CaloBTagCSV_PFJets_v1, fragment.HLTriggerFinalPath ))
